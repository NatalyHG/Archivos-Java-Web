...
import pe.egcc.services.MateService;
...
//        out.println("<h1>Hora del breakjnijninij!!!</h1>");
//        out.flush();
//        out.close();
    }
    ...
    private void suma(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<p>Num 1: "+num2+ "</p>");
        out.println("<p>Suma: "+resultado+ "</p>");
    }

    private void resta(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //Variables
        int num1, num2, resultado;
        MateService mateService= new MateService();
        //Datos
